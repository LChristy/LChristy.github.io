<html><head>
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="https://upload.wikimedia.org/wikipedia/commons/d/df/Refusal_of_treatment_form.jpg" class="img-responsive">
          </div>
          <div class="col-md-6">
    ...
    <div class="section">
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-6">
            <img src="https://upload.wikimedia.org/wikipedia/en/0/04/Alicia_Florrick%2C_The_Good_Wife_Season_5.jpg" class="img-responsive">
          </div>
        </div>
      </div>
    </div>
